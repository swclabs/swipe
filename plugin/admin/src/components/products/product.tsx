...
const DataWithStatus = (inputs: Products, status: string): ProductBody[] => {
    ...
    return inputs.data.filter((v) => v.status.toLowerCase() === status.toLowerCase());
}

export const TabsContentWithStatus = ({ input, status }: TabsContentParams) => {
