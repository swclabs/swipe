...
import { type NavItemWithChildren } from "@/types/navbar";
            ...
            <AccordionItem value={item.title} className="border-none ">
              <AccordionTrigger
                className={cn(
                  ...
                  'group relative flex h-10 justify-between px-4 py-2 text-sm duration-200 hover:bg-muted hover:no-underline',
                )}
              >
                <div>
